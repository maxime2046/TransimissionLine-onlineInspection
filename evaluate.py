...
def label_save_img(img_file,pred_result,img_labeled_save_path,pre_name):
    ...
    for xmlFile in os.listdir(resultPath):
        try:
            ...
            for pred_result_list in pred_result:
                ...
                pre_labeled_img = label_save_img(groundTruthFile,pred_result_list,img_labeled_save_path,xml_only_name)
                ...
                imag_name = pred_result_list['image_name']
